...
public class ControlPanelController {
	...
	private void showObjectPane() {
		...
		try {
			...
			loader.setLocation(getClass().getResource("/dsai/group24/force/view/ObjectPanel.fxml"));
	...
	private void showStatisticsPane() {
		...
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(getClass().getResource("/dsai/group24/force/view/StatisticsPanel.fxml"));
	...
	private void showForcePane() {
		...
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(getClass().getResource("/dsai/group24/force/view/ForcePanel.fxml"));
	...
	private void showSurfacePane() {
		...
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(getClass().getResource("/dsai/group24/force/view/SurfacePanel.fxml"));
